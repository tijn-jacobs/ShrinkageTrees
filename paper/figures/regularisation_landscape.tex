...
\node[filled, below=4mm of h2] (c12) {%
...
% ---------- Axis labels ----------
\node[axislabel] at ($(h2)+(0,0.9)$) {step-height prior — parametric shrinkage on leaves $\longrightarrow$};
\node[axislabel, rotate=90] at ($(c21.west)+(-2.2,1.4)$)
     {$\longleftarrow$ splitting rule — structural sparsity};
