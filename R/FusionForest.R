...
FusionShrinkageForest <- function(y,
                                  ...
                                  store_posterior_sample_deconf = FALSE,
                                  seed = NULL,
                                  verbose = TRUE
) {
  ...
  if (outcome_type == "right-censored") {
    ...
    fit <- FusionForest_cpp(
      ...
      store_posterior_sample_deconfSEXP = store_posterior_sample, 
      no_trees_deconfSEXP = number_of_trees_deconf,       
      power_deconfSEXP = power,                           # (reuse) or add a separate arg
