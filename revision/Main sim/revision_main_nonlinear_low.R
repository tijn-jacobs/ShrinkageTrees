...
cens_scales_nonlinear <- c(0.05612566, 0.04476263, 0.03058019)
...
output_file <- file.path(Sys.getenv("TMPDIR"), "revision_main_nonlinear_low_output.rds")
...
# # Load results
# res <- readRDS(
#   "~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/Main sim/revision_main_nonlinear_low_output.rds"
# )
# 
