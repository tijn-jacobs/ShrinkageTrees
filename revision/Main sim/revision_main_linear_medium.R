...
cens_scales_linear <- c(0.0232123)
...
output_file <- file.path(Sys.getenv("TMPDIR"), "revision_main_linear_medium_output.rds")
...
# # Load results
# res <- readRDS(
#   "~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/Main sim/revision_main_linear_medium_output.rds"
# )
# 
