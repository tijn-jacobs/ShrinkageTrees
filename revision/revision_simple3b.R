...
output_file <- file.path(Sys.getenv("TMPDIR"), "revision_simple3b_output.rds")
...
# 
# library(dplyr)
# final_flat_df <- readRDS("~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/revision_simple3b_output.rds")
# 
...
#   "~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/revision_simple3b_output.rds"
# )
# 
# #==================================================
