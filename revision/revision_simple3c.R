...
p_values <- round(10^seq(log10(500), log10(2000), length.out = 10))
...
output_file <- file.path(Sys.getenv("TMPDIR"), "revision_simple3c_output.rds")
...
# 
# library(dplyr)
# final_flat_df <- readRDS("~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/revision_simple3c_output.rds")
# 
...
#   "~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/revision_simple3c_output.rds"
# )
# 
# #==================================================
