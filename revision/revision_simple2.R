...
output_file <- file.path(Sys.getenv("TMPDIR"), "revision_simple2_output.rds")
...
library(dplyr)
final_flat_df <- readRDS("~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/revision_simple2_output.rds")
...
final_flat_df <- readRDS(
  "~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/revision_simple2_output.rds"
)
#final_flat_df3a_old #<- readRDS("~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/revision_simple3a_output.rds")
final_flat_df3a_new <- readRDS("~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/revision_simple3a_output.rds")
#final_flat_df3b_old #<- readRDS("~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/revision_simple3b_output.rds")
final_flat_df3b_new <- readRDS("~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/revision_simple3b_output.rds")
final_flat_df3c <- readRDS("~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/revision_simple3c_output.rds")


final_flat_df <- rbind(final_flat_df, final_flat_df3a_new, final_flat_df3a_old, final_flat_df3b, final_flat_df3c)
...
rmse_plot <- ggplot(sum_df,
  ...
  geom_smooth(
    data = subset(sum_df, Method != "SoftBART"),
    se = FALSE,
    method = "loess",
    span = 1.0,
    linewidth = 1.3
