...
output_file <- file.path(Sys.getenv("TMPDIR"), "short1_output.rds")
...
# 
# res <- readRDS(
#   "/Users/tijnjacobs/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/simulations revision/short1_output.rds"
# )$results_medium
# 
