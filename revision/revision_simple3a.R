...
p_values <- p_values[p_values <= 500]
...
output_file <- file.path(Sys.getenv("TMPDIR"), "revision_simple3a_output.rds")
...
# 
# library(dplyr)
# final_flat_df <- readRDS("~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/revision_simple3a_output.rds")
# 
...
#   "~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/revision_simple3a_output.rds"
# )
# 
# #==================================================
