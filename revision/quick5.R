...
p_vals <- round(seq(10, 10000, length.out = 50)) # Important to set number of p's!!!
...
output_file <- file.path(Sys.getenv("TMPDIR"), "quick5_output.rds")
...
# 
# 
# medium <- readRDS("/Users/tijnjacobs/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/simulations revision/quick5_output.rds")
...
# shape_values    <- c(ATE = 1, CATE = 0)
# 
# log_breaks <- c(10, 20, 50, 100, 200, 500, 1000, 2000, 5000)
# 
# smooth_fun <- geom_smooth(
#   se = FALSE,
#   method = "loess",
