...
cens_scales_medium <- c(
  0.05845115, 0.05814730, 0.05847000, 0.05750560, 0.05751194,
  0.05705848, 0.05711024, 0.05536953, 0.05453025, 0.05309781,
  0.05224884, 0.04902204, 0.04710513, 0.04545453, 0.04355119,
  0.03923160, 0.03694038, 0.03386671, 0.03283914, 0.02887247,
  0.02696475, 0.02631263, 0.02772461, 0.02729808, 0.02376848
)
...
output_file <- file.path(Sys.getenv("TMPDIR"), "quick1_output.rds")
...
# 
# medium <- readRDS("/Users/tijnjacobs/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/simulations revision/quick1_output.rds")
# medium <- medium$results_medium
# 
# #==================================================
# # Summarise all CATE metrics
# #==================================================
# sum_medium <- medium %>%
...
#     CATE_Detection_Power = mean(CATE_Detection_Power, na.rm = TRUE),
#     .groups = "drop"
#   )
# 
# #==================================================
...
# # 1) CATE RMSE
# #==================================================
# rmse_plot <- ggplot(sum_medium,
#                     aes(x = p_feat, y = CATE_RPEHE, color = Method)) +
#   smooth_fun +
#   x_scale +
#   scale_color_manual(values = method_colors) +
#   labs(x = "Number of covariates (log scale)",
#        y = "CATE RMSE",
#        title = "CATE RMSE") +
...
# # 2) CATE Coverage
# #==================================================
# coverage_plot <- ggplot(sum_medium,
...
# 
# #==================================================
# # 4) CATE Detection Power
# #==================================================
# power_plot <- ggplot(sum_medium,
#                      aes(x = p_feat, y = CATE_Detection_Power, color = Method)) +
#   smooth_fun +
#   x_scale +
#   scale_color_manual(values = method_colors) +
#   coord_cartesian(ylim = c(0, 1)) +
...
# #==================================================
# final_plot <- (rmse_plot + coverage_plot) /
#   (cilen_plot + power_plot) +
