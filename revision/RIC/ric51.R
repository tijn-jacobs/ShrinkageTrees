...
cens_scales <- c(0.03309140, 0.03441056, 0.03340906, 0.03259117, 0.03065769)
...
output_file <- file.path(Sys.getenv("TMPDIR"), "ric51_output.rds")
...
res <- readRDS(file.path(base_dir, "ric51_output.rds"))
results <- res$results
