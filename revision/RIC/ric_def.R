...
cens_scales <- c(
  0.03209226, 0.03019291, 0.03086435, 0.03195387, 0.03010789,
  0.03018917, 0.03079633, 0.02925795, 0.02979027, 0.03131492,
  0.02999563, 0.03005323, 0.03057644, 0.03110538, 0.03086828,
  0.02924487, 0.02942991, 0.03095499, 0.03080111, 0.02862911
)  
...
output_file <- file.path(Sys.getenv("TMPDIR"), "ric_def_output.rds")
...
# res <- readRDS(file.path(base_dir, "ric_def_output.rds"))
# results <- res$results
# 
# 
