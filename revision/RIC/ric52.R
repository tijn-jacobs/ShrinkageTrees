...
output_file <- file.path(Sys.getenv("TMPDIR"), "ric52_output.rds")
...
# res <- readRDS(file.path(base_dir, "ric52_output.rds"))
# results <- res$results
# 
# 
