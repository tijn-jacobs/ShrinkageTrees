...
output_file <- file.path(Sys.getenv("TMPDIR"), "quick4_output.rds")
...
medium <- readRDS("/Users/tijnjacobs/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/simulations revision/quick4_output.rds")
