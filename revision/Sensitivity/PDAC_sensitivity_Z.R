...
for (scen in scenarios) {
  ...
  res <- foreach(i = 1:M, .combine = rbind, 
                 .packages = c("ShrinkageTrees", "survival"), 
                 .export = c("run_single_simulation", "data_gen", "evaluate_CHF", "evaluate_CHF_CV", "covariates", "treatment", "propensity")) %dopar% {
...
output_file <- file.path(Sys.getenv("TMPDIR"), "PDAC_sensitivity_Z_output.rds")
...
# 
# 
# results <- readRDS("/Users/tijnjacobs/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/simulations revision/Sensitivity/PDAC_sensitivity_Z_output.rds")
# 
# library(dplyr)
