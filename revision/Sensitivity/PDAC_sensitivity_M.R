...
scenarios <- list(
  ...
  list(name = "07_Dim_High",         n_IV=0, iv_strength=0, n_M=25, m_strength=0.5),
  ...
  # list(name = "10_Stress_High",      n_IV=0, iv_strength=0, n_M=25, m_strength=2.0),
  # list(name = "11_Stress_Max",       n_IV=0, iv_strength=0, n_M=50, m_strength=2.0)
)
...
for (scen in scenarios) {
  ...
  res <- foreach(i = 1:M, .combine = rbind, 
                 ...
                 .export = c("run_single_simulation", "data_gen", 
                             ...
                             "covariates", "treatment", "propensity", 
...
output_file <- file.path(Sys.getenv("TMPDIR"), "PDAC_sensitivity_M_output.rds")
...
# 
# 
# results <- readRDS("/Users/tijnjacobs/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/simulations revision/Sensitivity/PDAC_sensitivity_M_output.rds")
# 
