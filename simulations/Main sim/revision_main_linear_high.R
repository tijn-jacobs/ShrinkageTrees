...
# cens_scales_linear <- c(0.02470207, 0.02403064, 0.02729808)

p_vals <- c(10000)
cens_scales_linear <- c(0.02729808)
...
output_file <- file.path(Sys.getenv("TMPDIR"), "revision_main_linear_high_output.rds")
...
# # Load results
# res <- readRDS(
#   "~/Library/CloudStorage/OneDrive-VrijeUniversiteitAmsterdam/Documents/GitHub/ShrinkageTrees/revision/Main sim/revision_main_linear_high_output.rds"
# )
# 
