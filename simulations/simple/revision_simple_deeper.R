...
output_file <- file.path(Sys.getenv("TMPDIR"), "revision_simple_deeper_output.rds")
...
library(dplyr)
final_flat_df <- readRDS("revision_simple_deeper_output.rds")
...
#==================================================
final_flat_df <- readRDS("revision_simple_deeper_output.rds")
#final_flat_df3a_old #<- readRDS("revision_simple_deeper3a_output.rds")
final_flat_df3a_new <- readRDS("revision_simple_deeper3a_output.rds")
#final_flat_df3b_old #<- readRDS("revision_simple_deeper3b_output.rds")
final_flat_df3b_new <- readRDS("revision_simple_deeper3b_output.rds")
final_flat_df3c <- readRDS("revision_simple_deeper3c_output.rds")


final_flat_df <- rbind(final_flat_df, final_flat_df3a_new, final_flat_df3b, final_flat_df3c)
...
ggsave(
  filename = "revision_simple_deeper_plot.png",
  plot = combined_plot,
  width = 1.2 * 250,
  height = 0.8 * 150,
  units = "mm",
