...
source(file.path(dirname(getwd()), "evaluation functions", "evaluation_functions_new.R"))
...
# 
# medium <- readRDS(
#   file.path(base_dir, "revision_main_deeper_output.rds")
# )
...
# # Save the plot
# ggsave(
#   filename = file.path(base_dir, "revision_main_deeper.png"),
#   plot = combined_plot,
